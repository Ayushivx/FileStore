...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text = f"<b>○ OWNER : <a href='tg://user?id={OWNER_ID}'>FUSION</a>\n○ MAIN CHANNEL : <a href='https://t.me/SkillBoostHub'>SkillBoost HUB</a>\n○ CHAT GROUP : <a href='https://t.me/+gsWJJEDtSOQ5ZGY1'>SkillBoost Hub Chat</a></b>",
            disable_web_page_preview = True,
            reply_markup = InlineKeyboardMarkup(
                [
                    [
                    InlineKeyboardButton("⚡️ CLOSE", callback_data = "close"),
                    InlineKeyboardButton('🍁 PREMIUM', url='https://t.me/SkillBoostHub')
                    ]
                ]
            )
        )
